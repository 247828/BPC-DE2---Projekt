...
/** @brief Set overflow 1.024ms, prescaler 100 --> 64 */
#define TIM2_ovf_1ms()  TCCR2B &= ~((1<<CS21) | (1<<CS20)); TCCR2B |= (1<<CS22);

/** @brief Set overflow 2.048ms, prescaler // 101 --> 128 */
#define TIM2_ovf_2ms()  TCCR2B &= ~(1<<CS21); TCCR2B |= (1<<CS22) | (1<<CS20);

/** @brief Set overflow 4.096ms, prescaler // 110 --> 256 */
#define TIM2_ovf_4ms()  TCCR2B &= ~(1<<CS20); TCCR2B |= (1<<CS22) | (1<<CS21);

/** @brief Set overflow 16.384ms, prescaler // 111 --> 1024 */
