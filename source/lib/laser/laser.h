...
#define LASER_TIMEOUT 250   // Timeout in seconds (adjust as needed)
...
extern volatile uint8_t last_button_state_laser; // Previous button state

// Function prototypes
void handle_button_laser(void);               // Function to toggle laser state based on button press
